import processing.core.*; import processing.core.*; import processing.video.*; import java.io.*; import ddf.minim.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class savie_movie_6 extends PApplet {
...
public void theCamera() {
  ...
  if(recordCam == 1) {                                                    // STOP WATCHING AND START RECORDING
    ...
    if (init) {
      //Process p; 
      String cmd = "rm /Users/David/Documents/Processing/savie_movie_6/cam1.mov";
...
public void setup() {
  ...
  static public void main(String args[]) {     PApplet.main(new String[] { "savie_movie_6" });  }}